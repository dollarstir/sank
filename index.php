<!--
Developer: Dollarstir
Developer URL: purplesofts.com
...
<head>
	<title>Sankofa Photograph</title>
	<!-- Meta tag Keywords -->
...
<body>
				...
				<div class="container">
					...
					<h1>
						<a class="navbar-brand font-weight-bold" href="index.html">
							<img src="images/logo2.png" alt="" class="img-fluid" style="width:150px;height:50px;"> 
						</a>
					</h1>
					<!-- //logo -->
					...
					<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
						<ul class="navbar-nav ml-lg-auto">
							...
							<li class="nav-item mx-lg-4 my-lg-0 my-3">
								<a class="nav-link scroll" href="#order">Order</a>
							</li>
							<li class="nav-item">
	...
	<!-- newsletter -->
	<div id="order"></div><
	<div class="newsletter_right_w3agile py-5" id="order1">
		<div class="container py-xl-5 py-lg-3">
			<!-- heading title -->
			<div class="main-title text-center mb-5">
				<h3 class="tittle text-uppercase text-white font-weight-bold">Place your order Here</h3>
				<div class="title-icon">
					<i class="fas fa-camera"></i>
				</div>
				<p class="sub-tittle text-light">Fill this form to book appointmnet with us</p>
			</div>
			<!-- //heading title -->
	...
	<div class="copy-right-w3ls py-3 border-top">
		<div class="container">
			<p class="copy-right-grids text-dark">© <?php echo date("Y");?> Sankofa Photography. All Rights Reserved | Design by
				<a href="https://purplesofts.com/" target="_blank">Purple Software</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
